...
export default function MainChat() {
  ...
  const MarkasRead = async () => {
    try {
      ...
      socket.emit("SendMessage", {
        recieverId,
        message: `${res.data} ${new Date().toDateString()}`,
      });
    } catch (error) {
      console.log(error);
    }
  ...
  return (
    <div className="main_chat_container">
      {isblock && <BlockChat onCloseBlock={onCloseBlock} />}
          ...
          {CurrConversation ? (
            <div className="right_chat_inner_container">
              <div className="chat_container_heading_right">
                ...
                <div className="current_conversation_cats">
                  {Reciever?.role !== 1 && (
                    <label
                      className="block"
            ...
            <div className="no_conversation">
              <div className="inner_no_cnversation">
                ...
                <h2>Select a conversation to start chat</h2>
              </div>
            </div>
          )}
        </div>
